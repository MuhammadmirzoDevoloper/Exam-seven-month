import Chapg1 from "../icons/Chapg1";
import Line from "../icons/Line";
import Onga from "../icons/Onga";
import Phone from "../icons/Phone";
import Qator from "../icons/Qator";
import Chapga from "../icons/chapga";
...
{/* --------------------- ASOSIY PAGE DIV ---------------------- */}
      ...
      <div className="Asosiy div class - ">
        <main className=" bg-[#141414] ">
          <div className="bg-[url('./img/Sub.png')] mx-auto  max-w-[1910px] h-[850px] mt-[-120px]  bg-center text-center pt-[825px] ">
          ...
          <div className=" container mx-auto px-5">
            ...
            <div className=" mb-[150px]">
              <div>
                <li>
                  <NavLink className="flex ml-8  gap-[60px]" to="/single">
            ...
            <div className=" mt-[150px] flex items-center justify-between">
              ...
              <div className="left flex p-2 rounded-md border border-gray-600 bg-black w-[150px] ">
                <button className=" bg-black  hover:bg-gray-600 p-2 rounded-md text-white">
                  Monthly
                </button>
                <button className=" bg-black  hover:bg-gray-600 p-2 rounded-md text-white">
                  Yearly
            ...
            <div className="ml-[80px] mt-11 grid grid-cols-3  gap-4">
